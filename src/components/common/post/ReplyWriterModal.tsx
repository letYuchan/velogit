...
const ReplyWriterModal = ({
    ...
    const handlePostCommentWorkflow = () => {
        ...
        if (
            ...
            const cmd = `npx tsx scripts/autoPostComment.ts ${fileName} ${ownerGithubName.trim()} ${ownerRepoName.trim()} ${commenterGithubName.trim()} ${githubToken.trim()}`;
...
export default ReplyWriterModal;
