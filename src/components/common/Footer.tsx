...
const Footer = () => {
  return (
    <footer className='bg-background flex max-h-[120px] w-full justify-between gap-4 p-5'>
      {/* copyright, license */}
      ...
      <div className='flex justify-around gap-4'>
        ...
        >
          ...
          <p className='font-title text-foreground text-2xl'>velogit</p>
        </a>
        <a
        ...
        >
          ...
          <p className='font-title text-foreground text-2xl'>contact</p>
        </a>
      </div>
    </footer>
  );
