      ...
      <div className='mt-4 flex w-full flex-nowrap justify-between px-4 sm:px-10 xl:px-36 2xl:px-64'>
        ...
        >
          ...
          <button
            ...
            className={clsx(
              'rounded-2xl border px-3 py-2 font-title text-lg font-bold transition-transform ease-in-out hover:scale-110 sm:text-xl',
          ...
          {categories.map(category => (
            <button
              ...
              className={clsx(
                'rounded-2xl border bg-background px-3 py-2 font-title text-lg font-bold transition-transform ease-in-out hover:scale-110 sm:text-xl',
