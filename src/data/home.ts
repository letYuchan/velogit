...
export const dragonEvolutionGifPathMap = {
    egg: 'images/system/growthDragon/egg.gif',
    baby: 'images/system/growthDragon/babyDragon.gif',
    teen: 'images/system/growthDragon/youngDragon.gif',
    adult: 'images/system/growthDragon/devFlare.gif',
    final: 'images/system/growthDragon/devnity.gif',
};
